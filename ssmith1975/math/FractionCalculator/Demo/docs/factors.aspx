<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="factors.aspx.cs" Inherits="Demo.docs.factors" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Factor API - Fraction Calculator</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="content">
            <h2>Factors API Documentation<a id="top"></a></h2>
            <h3>Purpose</h3>
